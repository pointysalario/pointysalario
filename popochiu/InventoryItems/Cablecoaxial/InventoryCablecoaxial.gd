...
const Data := preload('InventoryCablecoaxialState.gd')

var state: Data = preload('InventoryCablecoaxial.tres')
...
func on_look() -> void:
 E.run([
		"Player: Cómo que me dieron ganas de colgarme del cable.",
	])
