...
const Data := preload('InventoryCelularState.gd')

var state: Data = preload('InventoryCelular.tres')
...
func on_interact() -> void:
	.on_interact()
#	E.run([
#	'Player: Sin carga no puedo hacer mucha cosa.'
#	])
...
func on_look() -> void:
	E.run([
		'Player: Completamente apagado, no tiene carga.'
	])
